<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($data['tag_id'] == '') {
      $errors['tag_id'] = "Vui lòng chọn tag";
    }
    ...
    if (count($isset) > 0) {
      ...
      if($id_insert > 0) {
        ...
        $_SESSION['success'] = 'Thêm product mới thành công';
      }else {
        $_SESSION['error'] = 'Thêm product thất bại';
      }
        ...
        <div class="row">
            ...
            <form class="col-md-8" action="" method="post" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mt-1">
                      <select name="category_id">
                        ...
                        <?php foreach ($Category as $item) : ?>
                          <option value="<?php echo $item['id']; ?>" <?php echo isset($data['category_id']) && $data['category_id'] == $item['id'] ? "selected='selected'" : '' ?>><?php echo $item['namecate']; ?></option>
                        <?php endforeach; ?>
                      </select>
                    ...
                    <div class="col-sm-5">
                        ...
                        <?php foreach ($Tags as $item) : ?>
                          <option value="<?php echo $item['id']; ?>" <?php echo isset($data['tag_id']) && $data['tag_id'] == $item['id'] ? "selected='selected'" : '' ?>><?php echo $item['nametag']; ?></option>
                        <?php endforeach; ?>
                      </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="namepro" value="<?php echo isset($data['namepro']) ? $data['namepro'] : ''; ?>">
                ...
                <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control mt-2" name="description" row="4"><?php echo isset($data['description']) ? $data['description'] : ''; ?></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="number" class="form-control" name="price" placeholder="1.000$" value="<?php echo isset($data['price']) ? $data['price'] : ''; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="number" class="form-control" name="size_sm" value="<?php echo isset($data['size_sm']) ? $data['size_sm'] : 0; ?>">
                    </div> 
                    <label for="size_md" class="col-sm-1 col-form-label">Medium</label>
                    <div class="col-sm-2">
                        <input type="number" class="form-control" name="size_md" value="<?php echo isset($data['size_md']) ? $data['size_md'] : 0; ?>">
                    </div> 
                    <label for="size_lg" class="col-sm-1 col-form-label">Large</label>
                    <div class="col-sm-2">
                        <input type="number" class="form-control" name="size_lg" value="<?php echo isset($data['size_lg']) ? $data['size_lg'] : 0; ?>">
                    </div> 
                    <label for="size_xl" class="col-sm-1 col-form-label">XL</label>
                    <div class="col-sm-2">
                        <input type="number" class="form-control" name="size_xl" value="<?php echo isset($data['size_xl']) ? $data['size_xl'] : 0; ?>">
                    </div> 
                </div>
